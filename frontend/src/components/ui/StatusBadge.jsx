const STATUS_CONFIG = {
  ...
  PENDING_ACCEPTANCE: { label: 'Pending Acceptance', bg: 'bg-warning-50', text: 'text-warning-700', dot: 'bg-warning-500' },
  PENDING: { label: 'Pending', bg: 'bg-warning-50', text: 'text-warning-700', dot: 'bg-warning-500' },
  ACCEPTED: { label: 'Accepted', bg: 'bg-brand-50', text: 'text-brand-700', dot: 'bg-brand-500' },
  ...
  DISPUTED: { label: 'Disputed', bg: 'bg-danger-50', text: 'text-danger-700', dot: 'bg-danger-500' },

  // Milestone statuses
  CREATED: { label: 'Created', bg: 'bg-surface-100', text: 'text-surface-600', dot: 'bg-surface-400' },
  LOCKED: { label: 'Locked in Escrow', bg: 'bg-indigo-50', text: 'text-indigo-600', dot: 'bg-indigo-500' },
  ...
  HUMAN_REVIEW: { label: 'Human Review', bg: 'bg-warning-50', text: 'text-warning-700', dot: 'bg-warning-500' },
  REFUNDED: { label: 'Refunded', bg: 'bg-surface-100', text: 'text-surface-700', dot: 'bg-surface-500' },
  ...
  PROCESSING: { label: 'Processing', bg: 'bg-brand-50', text: 'text-brand-700', dot: 'bg-brand-500' },
...
export default function StatusBadge({ status, size = 'sm', showDot = true, className = '' }) {
  const normalizedKey = status ? String(status).toUpperCase().replace(/\s+/g, '_') : 'DRAFT';
